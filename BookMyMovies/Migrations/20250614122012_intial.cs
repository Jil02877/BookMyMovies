        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PopcornQty = table.Column<int>(type: "int", nullable: false),
                    ColdDrinkQty = table.Column<int>(type: "int", nullable: false),
                    TotalAmount = table.Column<float>(type: "real", nullable: false),
                    MoviePostingId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bookings_MoviePostings_MoviePostingId1",
                        column: x => x.MoviePostingId1,
                        principalTable: "MoviePostings",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_MoviePostingId1",
                table: "Bookings",
                column: "MoviePostingId1");
